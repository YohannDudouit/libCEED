...
extern "C" int initInterp(CeedScalar* d_B, CeedInt P1d, CeedInt Q1d, CeedScalar** c_B_ptr) {
...
extern "C" int initInterpGrad(CeedScalar* d_B, CeedScalar* d_G, CeedInt P1d, CeedInt Q1d, CeedScalar** c_B_ptr, CeedScalar** c_G_ptr) {
  const int Bsize = P1d*Q1d*sizeof(CeedScalar);
  cudaMemcpyToSymbol(c_B, d_B, Bsize, 0, cudaMemcpyDeviceToDevice);
  cudaGetSymbolAddress((void**)c_B_ptr, c_B);
